...
object List {
  ...
  // Exercise 3.19 Removes elements from list unless they satisfy a given predicate.
  // To remove odd numbers: filter(List(1,2,3,4))(_ % 2 == 0)
  def filter_mine[A](as: List[A])(f: A => Boolean): List[A] =
  ...
  //  - Same as for map, I implemented a non-stack-safe function. This solution uses local mutations.
