...
object List {
  ...
  // Exercise 3.16 Transform a list of ints by adding 1 to each element - Must be a pure function that return a new list
  def addOne_mine(as: List[Int]) =
    foldRight(as, Nil:List[Int])((a, acc) => append(List(a + 1), acc))

  // OFFICIAL SOLUTION
  // What I did differently:
  //   - I used the append function which was unnecessary more complicated requiring more work of appended a single item list everytime
  def add1(l: List[Int]) =
